        ...
        <div id="add_movie_container">
            <div id="import_fetch">
                ...
                <div id="import_fetch_fields">
                    ...
                    <div id="input_fetch">
                        <input type="text" placeholder="Enter TMDB Movie ID" id="fetch_input" value="">
            ...
            <div id="movie_fields">
                <hr>
                <form action="../../../handlers/addmovie.php" method="POST" id="movie__form">
                    <div id="movie__section_form" class="field_section">
                        ...
                        <div class="input_movie_info imdb_movie_id">
                            ...
                            <input type="text" name="imdb_movie_id" id="imdb_movie_id">
                        </div>
